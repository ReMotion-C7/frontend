...
//    
//    // <-- PERUBAHAN 1: Tambahkan state untuk alert
...
//                .ignoresSafeArea()
//                // <-- PERUBAHAN 2: Hapus .onTapGesture dari sini
//            
//            VStack(spacing: 20) {
//                headerSection
...
//        }
//        // <-- PERUBAHAN 3: Tambahkan dua modifier di bawah ini
//        .interactiveDismissDisabled() // Mencegah sheet ditutup dengan swipe
//        .alert("Batalkan Menambah Gerakan?", isPresented: $showExitAlert) {
//            Button("Batal", role: .cancel) { }
//            Button("Keluar", role: .destructive) {
//                showConfigModal = false // Tutup modal (sheet) ini
//            }
//        } message: {
//            Text("Perubahan yang Anda masukkan tidak akan disimpan. Apakah Anda yakin ingin keluar?")
//        }
//    }
//
//    private var headerSection: some View {
//        HStack {
//            // <-- PERUBAHAN 4: Ubah aksi tombol
//            Button(action: {
//                showExitAlert = true
//            }) {
